...
numberofstudents = input("Please enter number of students:")
numberofgroup = input("Please enter number of group: ")

groupAns=int(numberofstudents)//int(numberofgroup)
remAns=int(numberofstudents)%int(numberofgroup)

if groupAns>1 and remAns>1:
    print(f"There will be {groupAns} groups with {remAns} students left over.")
elif groupAns<=1 and remAns<=1:
    print(f"There will be {groupAns} group with {remAns} student left over.")   
elif groupAns<=1 and remAns>1:
    print(f"There will be {groupAns} group with {remAns} students left over.")  
else:
    print(f"There will be {groupAns} groups with {remAns} student left over.")  